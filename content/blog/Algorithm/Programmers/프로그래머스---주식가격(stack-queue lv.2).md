...
- 이미 정해진 값인 0을 결과 배열에 넣고 시작하기 때문에,  
  마지막 반복(첫번째 원소) 에 대한 작업은 수행하지 않는다.
...
- <a href='https://siahn95.tistory.com/12' target='-blank'>
'Python range(len()) vs enumerate() 속도 차이'</a>

- <a href='https://potensj.tistory.com/114' target='-blank'>
'[ Python Skill ] range 대신 enumerate를 써야하는 이유'</a>
...
- <a href='https://stackoverflow.com/questions/6148619/start-index-for-iterating-python-list' target='-blank'>
  'Start index for iterating Python list'</a>
...
\- 출처 : 
<a href='https://docs.python.org/ko/3/library/itertools.html#itertools.islice' target='-blank'>
'Python'
</a>
...
\- 출처 : 
<a href='https://gurumee92.tistory.com/170' target='-blank'>
'프로그래머스 문제 풀이 주식 가격'
</a>
...
- 확실하게 잘못된 접근이 아닌 이상, 더 끈기있게 문제를 풀어야 한다는 것도 배웠다.
   ...
   - <a href='/Algorithm/Programmers/프로그래머스---위장(hash-lv.2)/#배운-것' target='-blank'>
     '지난번 문제 풀이'</a> 
