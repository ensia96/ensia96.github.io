...
<details><summary>점화 플러그 객체에는 여러 기능들이 포함되어 있다.</summary>
...
- 많은 파일을 정리하거나, 효율적으로 탐색하는 데 사용할 수도 있다.
   - 개별 소스 파일의 수가 많은(규모가 큰) 프로그램에서 특히 유용하다.
...
- 거대한 프로그램과 관련된 여러 개념을 다루는 소프트웨어 공학 분야
...
- 프로그램 작성에 도움이 되는 여러 도구가 포함되어 있는 통합 개발 환경
