...
<details><summary>256비트 레지스터 기준, '16 * 16' 크기의 격자로 구성된다.</summary>

- 16개의 행(row) 과 열(column) 로 구성되어 있다.
...
위의 사진을 확대해서 자세하게 살펴보자.

> 이 구조는 임의의 래치를 하나 활성화하려면, 행 **그리고** 열을 함께 지정해줘야 한다.
