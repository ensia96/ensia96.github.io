...
- Karabiner 없이 키보드 키 재설정을 했다.
   - <a href='https://www.o3industries.se/rebind-keys-in-macos-without-karabiner-or-seil/' target='-blank'>
     'Rebind keys in macOS without Karabiner or Seil'</a>
     라는 글을 참고했다.
   ...
   - <a href='https://rakhesh.com/mac/using-hidutil-to-map-macos-keyboard-keys/' target='-blank'>
     'Using hidutil to map macOS keyboard keys'</a>
     라는 글을 참고했다.
   - <a href='https://hidutil-generator.netlify.app/' target='-blank'>
     'hidutil key remapping generator for MacOS'</a>
...
- 객체에 대해 공부했다.
   ...
   - 규모가 큰 프로그램에서 개념 단위를 나누는 데 유용하다.
